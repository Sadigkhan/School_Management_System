...
CREATE TABLE "Assingment" (
    ...
    CONSTRAINT "Assingment_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Assingment" ADD CONSTRAINT "Assingment_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lesson"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_examId_fkey" FOREIGN KEY ("examId") REFERENCES "Exam"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_assingmentId_fkey" FOREIGN KEY ("assingmentId") REFERENCES "Assingment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
