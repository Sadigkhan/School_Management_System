...
type TeacherList =Teacher & {subjects:Subject[]} & {classes:Class[] & {lessons:Lesson[]}}
...
const renderRow = (item:TeacherList) =>(
    ...
    <td className='flex items-center gap-4 p-4'>
        <Image src={item.image || "/noAvatar.png"} alt='teacher-image' width={40} height={40} className='md:hidden xl:block w-10 h-10 rounded-full object-cover'/>
